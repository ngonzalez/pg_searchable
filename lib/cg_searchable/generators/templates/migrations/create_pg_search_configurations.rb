class CreatePgSearchConfigurations < ActiveRecord::Migration
  def change
    ...
    # French config
    ActiveRecord::Base.connection.execute("DROP TEXT SEARCH CONFIGURATION IF EXISTS search_cfg_fr")
    ...
    ActiveRecord::Base.connection.execute("DROP TEXT SEARCH DICTIONARY IF EXISTS syn_dictionary_fr")
    ...
    ActiveRecord::Base.connection.execute("DROP TEXT SEARCH DICTIONARY IF EXISTS syn_dictionary_en")
